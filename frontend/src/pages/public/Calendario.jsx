...
const SESSIONS = [
  { n: 1, date: 'Miércoles 16 de septiembre de 2026', note: 'Presentación del curso, primeras reflexiones éticas e introducción a la ingeniería de prompts.' },
  { n: 2, date: 'Miércoles 23 de septiembre de 2026', note: 'Revisión de mini asistentes, puesta en común de planes de clase y resolución de dudas.' },
  { n: 3, date: 'Miércoles 30 de septiembre de 2026', note: 'Presentación de kits de recursos multimodales y cierre del curso.' },
];
              ...
              {SESSIONS.map((s) => (
                <div key={s.n} className="session-card" data-testid={`sesion-${s.n}`}>
                  ...
                  <div className="session-card__info">
                    ...
                    <p className="session-card__time">⏱ 17:00 – 18:30 h · hora peninsular española (GMT+2)</p>
