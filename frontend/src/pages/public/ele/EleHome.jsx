      ...
      <div className="home-hero">
        <div className="home-body">
          ...
          <div className="test-card reveal reveal--delay-3" data-testid="home-cta-card">
            ...
            <Link to="/curso-ele/precios" className="test-card__btn" data-testid="home-cta-precios">
          ...
          <div className="home-links">
            <Link to="/curso-ele/descripcion">Descripción y objetivos</Link>
            <Link to="/curso-ele/programa">Programa por módulos</Link>
            <Link to="/curso-ele/calendario">Calendario de videotutorías</Link>
            <Link to="/curso-ele/metodologia">Metodología y evaluación</Link>
          </div>
        </div>
      </div>
      <Footer />
