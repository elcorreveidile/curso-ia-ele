...
export const QUESTIONS = [
  ...
  { block: 'B', id: 'herramientas_dig', text: '¿Qué herramientas digitales usas actualmente? (puedes marcar más de uno)', type: 'checkbox', options: ['Aula Virtual / la plataforma del curso','Presentaciones (PowerPoint, Canva, Slides)','Quizlet, Kahoot, Genially','Vídeos (YouTube, series)','Podcasts o audio','Pizarra digital','Grabaciones propias','Principalmente sin herramientas digitales'] },
